...
export default async function AtendentePage() {
  const [ingredientsRaw, ordersRaw, eventStatus, productsRaw, promotionsRaw] = await Promise.all([
    ...
    prisma.promotion.findMany({ where: { active: true }, orderBy: { createdAt: "desc" } }),
  ]);
