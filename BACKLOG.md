...
- [x] **[P3] #pwa** Service Worker runtimeCaching pra `/p/<token>` — **PR #59 mergeada** [claude-pastel 2026-06-05]
...
### 2026-06-11
- [claude-pastel 2026-06-11 background] **[P3] Bookkeeping pós-merge de Fase 7** — `docs/FASE-7.md` atualizado: banner ✅ ENTREGUE + features #3/#4/#5 marcadas como feitas (PRs #29/#31/já existia). `BACKLOG.md` "Em progresso" zerado. `STATUS.md` métricas atualizadas (216/216 testes, Next 15 em main). Confirma: PR #23 Next 15 mergeado 2026-05-29, PR #4 backup mergeado 2026-06-09, PR #30 PIX mergeado 2026-06-05, PR #31 WhatsApp mergeado 2026-06-01, PR #59 SW cache mergeado 2026-06-09.
- [claude-pastel 2026-06-09] **[P1] Backup automático do `dev.db` — PR #4 mergeada** (`2fcd1b6`) — squash-merged junto das PRs #74/#75/#59/#41.
- [claude-pastel 2026-05-29] **[P2] Migração Next 14 → 15 + `@ducanh2912/next-pwa` — PR #23 mergeada** — next 15.5.18, react 19.2.6, fork PWA, codemod async params (14 rotas). Coolify deployou em prod.
