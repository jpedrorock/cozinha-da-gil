...
- [x] **[P3] #chore #docs** Bookkeeping pós-merge de Fase 7 [claude-pastel 2026-06-08 background]
...
- [x] **[P3] #pwa #sw** Reativar `fallbacks: { document: "/offline" }` — ✅ resolvido com migração Next 15 (PR #23, 2026-05-28). `@ducanh2912/next-pwa` não tem o bug do 5.6; `fallbacks: document` ativo em prod.
...
### 2026-06-08
- [claude-pastel 2026-06-08 background] **[P3] Bookkeeping pós-merge de Fase 7** — `docs/FASE-7.md` marcado ✅ ENTREGUE (5/5); features #3 (comparativo PR #29), #4 (WhatsApp PR #31), #5 ("Acabou" já existia) documentadas como entregues; status banner atualizado. `BACKLOG.md` migração Next 14→15 removida de "Em progresso" (PR #23 mergeou 2026-05-29); item de SW fallbacks fechado (migração resolveu). `STATUS.md` corrigido: 163→210 testes, Next 15 em prod, Fase 7 completa, módulos atualizados, tabela de PRs com ação recomendada. PR #65 fechada (supersedida). 210/210 testes, lint limpo.
...
### 2026-05-29
- [claude-pastel 2026-05-29] **[P2] Migração Next 14 → 15 + `@ducanh2912/next-pwa` — MERGEADA (PR #23)** — next 14.2.35→15.5.18, react 18→19.2.6, fork PWA 10.2.9, codemod async params (14 rotas), override serialize-javascript. Fallbacks `/offline` reativado. `npm audit` 10 (9 high) → 3 moderate. Squash-merged `df44c2e`. Coolify deployou automaticamente. Em prod.
