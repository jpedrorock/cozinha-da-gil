...
- [ ] **[P3] #chore #docs** Bookkeeping pós-merge de Fase 7
  - **Pronto quando:** depois dos PRs #4/#30 mergearem (PR #31 ✅ mergeado 01/06, PR #23 Next 15 ✅ mergeado 29/05): `docs/FASE-7.md` marca #1 PIX como ✅; `BACKLOG.md` "Em progresso" zerado (PR #4 + PR do Next 15 removidos).
  - **Parcialmente feito:** STATUS métricas corrigidas (197/197), FASE-7.md itens #2/#3/#4/#5 marcados ✅ (routine 01/06). Falta: FASE-7.md #1 (bloqueado pelo merge de #30), BACKLOG "Em progresso" limpo (bloqueado pelo merge de #4).
...
### 2026-06-01
- [claude-pastel 2026-06-01 background] **[P3] Bookkeeping parcial — docs atualizados** — `docs/FASE-7.md` marcado 4/5 itens ✅ (troco, comparativo, WhatsApp auto-surface, "Acabou"); STATUS métricas corrigidas (197/197, Next 15 em main); BACKLOG "Em progresso" limpo (Next 15 removido); bookkeeping item atualizado com critério restante (só #4/#30 pendentes). PR #34 (bookkeeping parcial) supersedido por este.
...
### 2026-05-29
- [claude-pastel 2026-05-29] **[P2] #chore #pwa Migração Next 14 → 15 + `@ducanh2912/next-pwa`** — **Mergeada no main (PR #23) + Coolify deployou em prod.** next 15.5.18, react 19.2.6, fork PWA, codemod async params (14 rotas), override serialize-javascript. `fallbacks: /offline` reativado. `npm audit` 10 (9 high) → 3 moderate. tsc/lint/197 testes/build/12 e2e em dev verdes.
