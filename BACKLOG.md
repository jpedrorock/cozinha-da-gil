...
### 2026-05-27
- [claude-pastel 2026-05-27 background] **E2E Playwright: fluxo completo de pedido** — `e2e/order-flow.spec.ts` cria pedido com 2 itens (pastel salgado + bebida), transita PEDIDO_FEITO → EM_PREPARO → PRONTO → ENTREGUE usando contextos isolados por papel (admin/atendente/cozinha). 1 passed.
