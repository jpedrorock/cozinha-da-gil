...
### 2026-05-26
- [claude-pastel 2026-05-26 background] **E2E Playwright: fluxo completo de pedido** — `e2e/order-flow.spec.ts` criado: 4 specs cobrindo golden path (atendente → cozinha → entrega), bypass bebida (PRONTO direto), transição inválida (409 + INVALID_TRANSITION code), e pedido terminal (ENTREGUE sem revert). Lint OK, Vitest 57/57. E2E inconclusivo em background (sem servidor; todas as suites existentes também falham por ECONNREFUSED — esperado).
