...
### 2026-06-13
- [claude-pastel 2026-06-13 background] **[P3] Bookkeeping pós-Fase 7** — `docs/FASE-7.md` marcado ✅ ENTREGUE (5/5); features #3 (comparativo), #4 (WhatsApp pronto), #5 (Acabou) atualizadas com entrega. BACKLOG "Em progresso" zerado (PR #4 backup + next15-pwa já mergeados em main há semanas). Reflete estado real do projeto.
- [claude-pastel 2026-06-13 background] **[P3] Investigar routine background criando branches sem trabalho** — causa raiz identificada: prompt da routine cria branch + abre PR incondicionalmente no passo final, mesmo com 0 itens executados. Fix documentado em PLAYBOOK (seção "Problema conhecido: branches log-only acumuladas") com roteiro exato pra João ajustar o prompt da routine. Fix esperado: guarda "se 0 itens executados → commit STATUS em main direto, skip branch + PR".
