        ...
        <div className="ml-auto flex items-center gap-2 min-w-0">
          ...
          {showOperator && operator && (
            <button
              ...
              className="inline-flex items-center gap-1.5 h-11 pl-2 pr-2 md:pr-3 rounded-full border border-line-strong text-ink-2 hover:border-ink-3 hover:text-ink max-w-[160px] md:max-w-none"
