...
> **Status: ✅ ENTREGUE.** Todas as 5 features estão mergeadas em main.
> Este doc é o plano original mantido como referência histórica.
...
- **Entregue:** sub-aba no admin Vendas com comparativo por `EventSession`. Mergeada em main em 2026-05-29.
...
- **Entregue:** banner fixed-bottom 1-toque quando vira PRONTO + tem telefone, reusa `notifyReady()`. Mergeada em main em 2026-06-01.
...
- **Verificado em 2026-05-29:** já estava implementado — PATCH ingrediente → broadcast `ingredient:updated` → atendente aplica `available` ao vivo. Nada a fazer.
