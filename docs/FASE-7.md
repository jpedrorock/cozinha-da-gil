...
> **Status: ✅ ENTREGUE.** 5/5 features implementadas e mergeadas em main (2026-05-29 a 2026-06-05).
> Este doc é o **plano original** da Fase 7, mantido como referência histórica.
> Detalhes de implementação podem divergir do plano — o código é a fonte de verdade.
...
## 3. Comparativo entre eventos (admin) — ✅ FEITA (PR `claude-pastel/comparativo-eventos`, mergeada 2026-05-29)
...
- **Status:** verificado — PATCH ingrediente → broadcast `ingredient:updated` → atendente aplica `available` ao vivo. Já funcionava sem mudança de código.
